...
%which is smaller than 1-THRESH1. The percentage is computed over the entire abs(sum) of the coefficients values.
    ...
    figure('name',sprintf('DCT Transform with elimination ratio = %1.2f',n_iter/numel(img)));
    subplot(2,2,1); imshow(img); freezeColors; title('Original Image');
